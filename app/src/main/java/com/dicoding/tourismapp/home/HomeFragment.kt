    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            homeViewModel.tourism.observe(viewLifecycleOwner) { tourism ->
                if (tourism != null) {
                    when (tourism) {
                        is com.h1194.core.data.Resource.Loading -> binding.progressBar.visibility = View.VISIBLE
                        is com.h1194.core.data.Resource.Success -> {
                            binding.progressBar.visibility = View.GONE
                            gamesAdapter.submitList(tourism.data)
                        }
                        is com.h1194.core.data.Resource.Error -> {
                            binding.progressBar.visibility = View.GONE
